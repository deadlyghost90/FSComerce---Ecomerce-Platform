 ...
 * Example:
 * `transactions: [{ paymentMethodDetails: {type: {eq: "CARD"}} }, {paymentMethodDetails: {card: {eq: "FSCommerceCard"}}}]`
 * is created from two separate inputs for Payment method = "CARD" and Payment method card = "FSCommerceCard" l*/
